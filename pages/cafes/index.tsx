  ...
  return (
    <>
      ...
      <div style={{ marginTop: "1rem" }}>
        ...
        <label style={{ marginLeft: "1rem" }} htmlFor="quietselect">
          Quiet:{" "}
        </label>
        <select
          id="quietselect"
        ...
        <label style={{ marginLeft: "1rem" }} htmlFor="outletselect">
          Outlet:{" "}
        </label>
        <select
          id="outletselect"
        ...
        <label style={{ marginLeft: "1rem" }} htmlFor="wifiselect">
          Wifi:{" "}
        </label>
        <select
          className="border border-black px-2 py-2 rounded-md"
        ...
        <label style={{ marginLeft: "1rem" }} htmlFor="coffeeselect">
          Coffee:{" "}
        </label>
        <select
          className="border border-black px-2 py-2 rounded-md"
        ...
        <label style={{ marginLeft: "1rem" }} htmlFor="teaselect">
          Tea:{" "}
        </label>
        <select
          className="border border-black px-2 py-2 rounded-md"
